...
|------|---------|------|---------|
| [WxAI — AI 인지와 행동](ai.md) | WxAI는 인지 결과를 Blackboard로 전달하고 Behavior Tree 노드로 이동·전투 행동을 구성한다. | wx, ai | 2026-09-23 |
| [WxCombat — 전투 시스템](combat.md) | WxCombat은 GAS의 어빌리티·자원·피해 처리와 전투 연출을 제공하고, 캐릭터 조립은 WxGame이 맡는다. | wx, combat | 2026-09-24 |
