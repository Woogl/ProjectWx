...
- 경과: 제출(2026-09-24, 사용자 "제출하려고 합니다") — 인게임 확인 대기. 이어서 NameplateManager를 WxGame으로 옮기고 오래된 CoreRedirects를 제거해 제출했다(2026-09-24, 사용자 "제출해주세요", 아래 "NameplateManager WxGame 이동" 절, Wiki 반영: raw `2026-09-24-nameplate-manager-wxgame.md`와 UI·게임 조립·전투 문서). Wiki 반영 완료(2026-09-24, UI의 머리 위 Nameplate 절·게임 조립·전투)
