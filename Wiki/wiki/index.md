...
- [[결정 노트 - 2026-09-26-animnotify-label-acceptance]] — 몽타주 타임라인에서 AnimNotify 17종 짧은 라벨의 값 일치와 겹침·잘림 없는 가독성을 사람이 확인한 범위와 그 경계
...
- [[결정 노트 - 2026-09-26-row-preview-acceptance]] — DataTable Row 미리보기의 빈 구조체 축약·설정값 표시·셀과 툴팁 일치를 사람이 확인했고 과거 자동화 테스트는 제출 전 제거된 이력임을 정리
