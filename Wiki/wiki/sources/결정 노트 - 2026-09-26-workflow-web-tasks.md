...
- 후속(2026-09-26, 워크플로우 종합 점검 Q7): 구현 승인 전 정하기 단계의 추가 요청은 읽기 전용으로 실행하기로 정해져, 핵심 주장 c2의 「추가 요청은 모든 명령 허용」은 새 주장으로 대체되어 deprecated가 됐다. 현재 규칙은 정본 `.agents/workflow/process/index.md`를 본다. ([[작업 - workflow-inspection]])
