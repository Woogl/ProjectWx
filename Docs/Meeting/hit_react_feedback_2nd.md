...
* PC를 설명할 때 적에 대해서도 같이 설명하는 부분 (7번 단락)
...
* "경직 우선순위" 관련
  ...
  * 대미지 프로세스가 동기적(Synchronous)으로 실행되기 때문으로, 절대 다중 실행되지 않습니다.
...
## 개선 방안 4. 통합 다이어그램 1개만 사용

다이어그램 하나로, 글 전체 내용을 한눈에 파악하기 쉽게 정리하는게 좋습니다.
