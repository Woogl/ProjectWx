...
- **후속 조치(2026-08-31)**: 동기 push API를 제거하고 사망·대화·HUD를 `UWxAsyncAction_PushWidgetToLayer`로 전환했다. 대화/HUD 요청 취소와 레이아웃 교체 검증을 함께 넣어 지연 완료가 끝난 화면이나 새 월드에 push되지 않게 했다.
