...
protected:
	...
	// VisibleAnywhere + AllowPrivateAccess: StateTree 의 Play Animation 이 Context 액터의 컴포넌트로 바인딩하기 위한 노출.
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Wx", meta = (AllowPrivateAccess = "true"))
	TObjectPtr<USkeletalMeshComponent> MeshComponent;

	// EditAnywhere + AllowPrivateAccess: 디자이너가 값을 설정하고, StateTree 의 Grant Reward 태스크가 Context 액터의 프로퍼티로 바인딩해 읽는다.
