 ...
 * ST_SpawnConsole 의 Trigger Spawners 가 이 TargetSpawners 를 바인딩한다.
 */
UCLASS(Abstract)
...
protected:
	...
	// EditInstanceOnly + AllowPrivateAccess: 디자이너가 인스턴스마다 지정하고, StateTree 의 Trigger Spawners 가 Context 액터 프로퍼티로 바인딩하기 위한 노출.
