 ...
 *
 * 컷신 시퀀스는 부여 시점에 비동기로 미리 잡아 둔다 — LevelSequence 는 카메라·머티리얼·사운드까지 함께 끌고 오므로,
 * 발동 순간에 로드하면 하필 연출이 시작되는 지점에서 프레임이 튄다.
 */
UCLASS()
...
private:
	...
	/** 컷신 시퀀스의 프리로드 핸들. 이 핸들이 곧 GC 방지이므로 어빌리티가 살아 있는 동안 들고 있는다. */
