...
/**
 * 이동 속도를 배율만큼 조절하는 무한 지속 GE. 배율은 SetByCaller.MoveSpeedScale 로 실어 보낸다.
 *
 * SPD 는 MaxWalkSpeed 에 곱해지는 배율이고 그 반영은 AWxCharacterBase 의 SPD 콜백이 전담하므로,
 * 일시적인 감속·가속은 CharacterMovement 를 직접 쓰지 말고 이 GE 를 부여·제거해서 표현한다.
