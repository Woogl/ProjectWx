...
## 책임
**담당**
- 활성 SaveGame 슬롯의 소유·수명 관리(맵 트래블을 가로질러 유지), 디스크 저장/로드, 슬롯 리셋 (`UWxPersistenceGameSubsystem`)
...
| `FWxPersistenceTravelData` | 로드 시 트래블 대상 맵(`FSoftObjectPath Map`) | `Plugins/WxSave/Source/WxSave/Public/WxPersistenceSaveGame.h` |
| `UWxSaveFilePersistenceUtils` | BP 진입점. 게임 서브시스템 공개 API 의 정적 래퍼(Save/Load/Reload/Travel) | `Plugins/WxSave/Source/WxSave/Public/WxSaveFilePersistenceUtils.h` |
