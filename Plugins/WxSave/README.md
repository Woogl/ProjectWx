...
- **재개 지점 주입**: `UWxPlayerSpawnComponent` 는 GameMode 의 `FrameworkComponents` 에 등록해야 부착된다 — 미등록 시 재개 지점·스탯 복원이 조용히 동작하지 않는다.
...
---
*문서 기준 커밋 `c275320` · 생성일 2026-07-24 · 소스 13파일 — `/readme-writer`로 갱신*
