...
namespace WxGameplayTags
{
	...
	/** 기믹 상태 변경 이벤트. State enum 구동 기믹이 자기 StateTree에 송출해 현재 State에 맞는 상태로 Root 재선택을 유발. AWxDoor가 사용 */
	WXCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Gimmick_StateChanged);
