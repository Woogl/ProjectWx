 ...
 * 새 플레이어가 무엇을 들고 시작하는지는 Experience 가 정한다(본체·액션셋의 시작 아이템 합산) — 본 클래스는 지급 시점만 관장해 그 컨트롤러의 인벤토리에 넣는다(PlayerController 는 인벤토리를 알지 않는다).
...
private:
	...
	/** 접속자 1인에게 Experience 가 정의한 시작 아이템(본체·액션셋 합산)을 지급한다. */
