 ...
 * 넷모드와 무관하게 전 엔트리를 컴포넌트 매니저에 요청만 한다 — 복제 컴포넌트는 매니저가 authority 액터에서만 생성하고, 비복제 컴포넌트의 사이드 제한은 컴포넌트 자신이 한다(권위 전용은 HasAuthority 가드, 로컬 표시 전용은 IsLocalController 가드).
