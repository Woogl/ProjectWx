...
// UWxAbilityBase 파생 Blueprint 의 에디터 썸네일을 UWxAbilityComponent_UIData 의 아이콘 텍스처로 렌더링한다.
// UIData 컴포넌트가 없거나 아이콘이 지정되지 않은 경우, 그리고 어빌리티가 아닌 일반 Blueprint 는 엔진 기본 동작(Super)으로 위임한다.
UCLASS()
