...
상태: 확인 대기 · 사망·부활·새 게임 사용자 확인 통과
다음 행동: 재시작 뒤 부활·슬롯 공유·코드 리뷰를 확인한다.
...
| 항목 | 확인 방법 | 담당 | 결과 | 근거 |
| --- | --- | --- | --- | --- |
| 사망·부활·새 게임 | 게임: 체크포인트 저장 뒤 사망·부활, 새 게임 초기화 | 사람 | 통과 | 이우성 2026-09-25 · 대시보드 전달 두 번 |
...
| 코드 리뷰 | UWxCheckpointSaveGame·SaveCheckpoint 태스크·부활·새 게임 호출부 | 사람 | 대기 |  |
