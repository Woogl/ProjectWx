...
대시보드에서 **새 작업**이나 작업의 **작업 진행**을 누르면 지금 사람이 할 일 하나가 나옵니다. 이름을 적고 전달합니다. 처리할 AI(Codex·Claude Code·Gemini CLI 중 연결된 것)는 왼쪽 메뉴 아래에서 한 번 고르며, 모든 전달·터미널·Wiki 갱신이 그 AI를 씁니다.
