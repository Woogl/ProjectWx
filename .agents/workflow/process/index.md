...
- Wiki(`Wiki/`, Obsidian으로 읽음)는 Wiki 갱신만 씁니다. 매일 새벽 정기 갱신 Routine이 완료된 작업 기록과 기획서에서 재사용할 지식을 옮기고, 바로 갱신해야 하면 대시보드의 **Wiki 갱신**에서 고른 AI가 이 PC에서 같은 절차로 갱신합니다. 작업 중인 AI와 사람은 Wiki를 고치지 않고, 사람은 고칠 내용을 체크리스트 결과·AI에게 추가 요청·새 작업으로 남깁니다. 갱신 절차는 [Wiki 안내](../../../Wiki/README.md)에 있습니다.
